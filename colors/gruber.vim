...
" Colors
let s:black     = ["#0c0c0c", "234"]
"let s:black     = ["#02061A", "234"]
let s:graphite  = ["#262626", "235"]
"let s:graphite  = ["#13172B", "235"]
...
" Syntax
call s:hl("Comment",        { "fg": s:brown, "style": "bold,italic" })
